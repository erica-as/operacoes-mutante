...
describe('Suíte de Testes Fraca para 50 Operações Aritméticas', () => {
  ...
  test('4.1. deve manter a mensagem de erro na divisão por zero', () => {
  ...
  test('6.1. deve retornar 0 para raiz quadrada de 0', () => { expect(raizQuadrada(0)).toBe(0); });
  ...
  test('8.1. deve retornar 1 para fatorial de 0 e 1', () => {
    expect(fatorial(0)).toBe(1);
    expect(fatorial(1)).toBe(1);
  });
  test('8.2. deve lançar erro para fatorial de número negativo', () => {
  ...
  test('9.1. deve retornar 0 para média de array vazio', () => { expect(mediaArray([])).toBe(0); });
  ...
  test('11.1. deve lançar erro para máximo de array vazio', () => {
  ...
  test('12.1. deve lançar erro para mínimo de array vazio', () => {
  ...
  test('15.1. deve retornar false para um número ímpar', () => { expect(isPar(7)).toBe(false); });
  test('16. deve retornar true para um número ímpar', () => { expect(isImpar(7)).toBe(true); });
  test('16.1. deve retornar false para um número par', () => { expect(isImpar(8)).toBe(false); });
  ...
  test('33.1. deve retornar false para números não primos', () => {
  ...
  test('35.1. deve retornar 1 para produto de array vazio', () => { expect(produtoArray([])).toBe(1); });
  test('36. deve manter um valor dentro de um intervalo (clamp)', () => { expect(clamp(5, 0, 10)).toBe(5); });
  test('36.1. deve manter limites inclusivos no clamp', () => {
    expect(clamp(0, 0, 10)).toBe(0);
    expect(clamp(10, 0, 10)).toBe(10);
  });
  test('36.2. deve ajustar valores fora do intervalo no clamp', () => {
    expect(clamp(-1, 0, 10)).toBe(0);
    expect(clamp(11, 0, 10)).toBe(10);
  });
  test('37. deve verificar se um número é divisível por outro', () => { expect(isDivisivel(10, 2)).toBe(true); });
  test('37.1. deve retornar false quando não é divisível', () => { expect(isDivisivel(10, 3)).toBe(false); });
  test('38. deve converter Celsius para Fahrenheit', () => { expect(celsiusParaFahrenheit(0)).toBe(32); });
  test('38.1. deve converter 100C para 212F', () => { expect(celsiusParaFahrenheit(100)).toBe(212); });
  test('39. deve converter Fahrenheit para Celsius', () => { expect(fahrenheitParaCelsius(32)).toBe(0); });
  test('39.1. deve converter 212F para 100C', () => { expect(fahrenheitParaCelsius(212)).toBe(100); });
  test('40. deve calcular o inverso de um número', () => { expect(inverso(4)).toBe(0.25); });
  test('40.1. deve lançar erro para inverso de 0', () => {
  ...
  test('44.1. deve retornar false quando números são iguais', () => { expect(isMaiorQue(5, 5)).toBe(false); });
  test('45. deve verificar se um número é menor que outro', () => { expect(isMenorQue(5, 10)).toBe(true); });
  test('45.1. deve retornar false quando números são iguais', () => { expect(isMenorQue(5, 5)).toBe(false); });
  test('46. deve verificar se dois números são iguais', () => { expect(isEqual(7, 7)).toBe(true); });
  test('46.1. deve retornar false quando números são diferentes', () => { expect(isEqual(7, 8)).toBe(false); });
  test('47. deve calcular a mediana de um array ímpar e ordenado', () => { expect(medianaArray([1, 2, 3, 4, 5])).toBe(3); });
  test('47.1. deve calcular a mediana de um array par e desordenado', () => {
    expect(medianaArray([4, 1, 2, 3])).toBe(2.5);
  });
  test('47.2. deve lançar erro para mediana de array vazio', () => {
